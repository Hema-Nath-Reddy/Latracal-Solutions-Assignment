...
const Login = () => {
  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col overflow-x-hidden text-white" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      <div className="absolute inset-0 z-0">
        <img alt="background" className="h-full w-full object-cover opacity-20" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAaaKiAhcX4RCxDfAH0TcNl_LWIqZQroPULa5YaakFPVlZGvjJ5RlHzu7Eh_DgbMVznnCK6ecNgPJA3bgYf-n7UcehBi96SlEQQ-L8t4DSEphGOnch64HkIVmp5WRJ3V94DqOk9ZPKfcYdv9wtbWBOOPtfwNRIYP316uKzH-UcIajMtwSez1aWqrkK6S3hFUmzMY_4-Fhat7BjLyNRIKh6DeXnkq363VFDZ944yNmqxf1dr86R7_la-mYJwPuVERZN9IpOsDPLcPb8" />
        ...
        <main className="flex flex-1 items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-md space-y-8 rounded-2xl bg-black/30 backdrop-blur-lg p-8 shadow-2xl">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-end">
                <div className="text-sm">
                  <a className="font-medium text-gray-400 hover:text-[var(--primary-color)] transition-colors" style={{ '--primary-color': primaryColor }} href="#">
            ...
            <p className="mt-6 text-center text-sm text-gray-400">
              ...
              <a className="font-medium text-[var(--primary-color)] hover:text-red-400 transition-colors" style={{ '--primary-color': primaryColor }} href="#">
                Sign up
              </a>
            </p>
          </div>
